...
4) Rodar o comando no mesmo diretório do código:
		->python grafo.py
5) Caso na segunda linha do arqiovo ".txt" exista apenas um valor, a saída serão todos os menores caminhos de "s" até todos os outros vértices, seguido das matrizes de menores caminhos obtidas por cada um dos algoritmos;
